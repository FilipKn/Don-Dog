...
function dondog_render_footer_shortcode( $atts ) {
	$atts = shortcode_atts(
		[
			...
			'address_icon'   => '',
			'address'        => 'Slovenska cesta 42, Ljubljana',
			'phone_icon'     => '',
			'phone'          => '+386 1 234 5678',
			'phone_url'      => 'tel:+38612345678',
			'email_icon'     => '',
			'email'          => 'info@dondog.si',
			'email_url'      => 'mailto:info@dondog.si',
			'hours_title'    => 'Delovni cas',
			'hours_icon'     => '',
			'hours_items'    => 'Pon - Pet|8:00 - 18:00;Sob|9:00 - 15:00;Ned|Zaprto',
			'copyright'      => '(c) 2026 Don Dog. Vse pravice pridrzane.',
